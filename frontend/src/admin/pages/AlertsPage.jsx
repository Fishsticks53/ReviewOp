...
export default function AlertsPage({ alerts = [], isDark, onAlertClick }) {
    ...
    { field: "severity", headerName: "Severity", width: 120, 
      renderCell: (params) => (
        <span className={`px-2 py-1 rounded text-xs font-bold ${
          params.value === "Critical" ? "bg-red-500 text-white" :
          params.value === "Warning" ? "bg-amber-500 text-slate-900" :
